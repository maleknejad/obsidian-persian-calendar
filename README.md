...
| :--- | :--- | :--- |
| `{{تاریخ شمسی یادداشت}}` | 1403-02-01 | تاریخ روزنوشت را برمی‌گرداند. |
| `{{تاریخ میلادی یادداشت}}` | 2024-04-20 | تاریخ روزنوشت را برمی‌گرداند. |
| `{{تاریخ قمری یادداشت}}` | 1445-10-11 | تاریخ روزنوشت را برمی‌گرداند. |
| `{{روز هفته یادداشت}}` | شنبه | نام روز هفته روزنوشت را برمی‌گرداند. 
| `{{روز ماه یادداشت}}` | 23 | روز ماه یادداشت را برمی‌گرداند. |
| `{{مناسبت یادداشت}}` | (همان متنی که در تولتیپ نمایش داده می‌شود) | مناسبت‌های روزنوشت را برمی‌گرداند. |
...
| `{{اول هفته}}` | 1403-01-01 | روز اول هفته‌نوشت را برمی‌گرداند. |
| `{{آخر هفته}}` | 1403-01-07 | روز آخر هفته‌نوشت را برمی‌گرداند. |
...
| `{{اول ماه}}` | 1403-02-01 | روز اول ماه‌نوشت را برمی‌گرداند. |
| `{{آخر ماه}}` | 1403-02-31 | روز آخر ماه‌نوشت را برمی‌گرداند. |
...
| `{{اول فصل}}` | 1403-01-01 | روز اول فصل‌نوشت را برمی‌گرداند. |
| `{{آخر فصل}}` | 1403-03-31 | روز آخر فصل‌نوشت را برمی‌گرداند. |

### **عبارات معنادار وابسته به سال‌نوشت**
| عبارت | مقادیر نمونه | توضیحات |
| :--- | :--- | :--- |
| `{{سال یادداشت}}` | 1403 | سال یادداشت را برمی‌گرداند. |
| `{{اول سال}}` | 1403-01-01 | روز اول سال را برمی‌گرداند. |
| `{{آخر سال}}` | 1403-12-30 | روز آخر سال را برمی‌گرداند. |
...
| `{{روز ماه جاری}}` | 25 | روز ماه امروز را برمی‌گرداند. |
...
| `{{مناسبت جاری}}` | (همان متنی که در تولتیپ نمایش داده می‌شود) | مناسبت‌های امروز را برمی‌گرداند. |
