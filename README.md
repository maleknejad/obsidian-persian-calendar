...
| :--- | :--- | :--- |
| **روز** | | |
| `{{تاریخ یادداشت}}` | 1403-02-01 | تاریخ روز نوشت را برمی‌گرداند. |
| `{{روز هفته یادداشت}}` | شنبه | نام روز هفته روز نوشت را برمی‌گرداند. |
| **هفته** | | |
| `{{هفته یادداشت}}` | 1403-W6 | شماره هفته روز نوشت را برمی‌گرداند. |
| `{{اول هفته}}` | 1403-01-01 | روز اول هفته‌نوشت را برمی‌گرداند. **فقط در هفته‌نوشت کار می‌کند.** |
| `{{آخر هفته}}` | 1403-01-07 | روز آخر هفته‌نوشت را برمی‌گرداند. **فقط در هفته‌نوشت کار می‌کند.** |
| **ماه** | | |
| `{{ماه یادداشت}}` | 1403-02 | شماره ماه روز نوشت را برمی‌گرداند. |
| `{{نام ماه یادداشت}}` | اردیبهشت | نام ماه روز نوشت را برمی‌گرداند. |
| `{{اول ماه}}` | 1403-02-01 | روز اول ماه‌نوشت را برمی‌گرداند. **فقط در ماه‌نوشت کار می‌کند.** |
| `{{آخر ماه}}` | 1403-02-31 | روز آخر ماه‌نوشت را برمی‌گرداند. **فقط در ماه‌نوشت کار می‌کند.** |
| **فصل** | | |
| `{{فصل یادداشت}}` | 1403-S1 | شماره فصل روز نوشت را برمی‌گرداند. |
| `{{نام فصل یادداشت}}` | بهار | نام فصل روز نوشت را برمی‌گرداند. |
| `{{اول فصل}}` | 1403-01-01 | روز اول فصل‌نوشت را برمی‌گرداند. **فقط در فصل‌نوشت کار می‌کند.** |
| `{{آخر فصل}}` | 1403-03-31 | روز آخر فصل‌نوشت را برمی‌گرداند. **فقط در فصل‌نوشت کار می‌کند.** |
| **سال** | | |
| `{{سال یادداشت}}` | 1403 | سال روز نوشت را برمی‌گرداند. |
| `{{اول سال}}` | 1403-01-01 | روز اول سال‌نوشت را برمی‌گرداند. **فقط در سال‌نوشت کار می‌کند.** |
| `{{آخر سال}}` | 1403-12-30 | روز آخر سال‌نوشت را برمی‌گرداند. **فقط در سال‌نوشت کار می‌کند.** |
| **وابسته به زمان حال** | | |
| `{{تاریخ جاری}}` | 1403-08-03 | تاریخ امروز را برمی‌گرداند. |
| `{{روز هفته جاری}}` | پنج‌شنبه | نام روز هفته امروز را برمی‌گرداند. |
| `{{هفته جاری}}` | 1403-W32 | شماره هفته جاری را برمی‌گرداند. |
| `{{نام ماه جاری}}` | آبان | نام ماه جاری را برمی‌گرداند. |
| `{{ماه جاری}}` | 1403-08 | شماره ماه جاری را برمی‌گرداند. |
| `{{نام فصل جاری}}` | پاییز | نام فصل جاری را برمی‌گرداند. |
| `{{فصل جاری}}` | 1403-S3 | شماره فصل جاری را برمی‌گرداند. |
| `{{سال جاری}}` | 1403 | سال جاری را برمی‌گرداند. |
| `{{روزهای گذشته}}` | 32 | تعداد روزهای گذشته از ابتدای سال **روز نوشت** را برمی‌گرداند. |
| `{{روزهای باقیمانده}}` | 333 | تعداد روزهای باقی‌مانده تا پایان سال **روز نوشت** را برمی‌گرداند. |
| `{{مناسبت}}` | متنی که در تولتیپ نمایش داده می‌شود | مناسبت‌های **روز نوشت** یا امروز (بر اساس تنظیمات) را برمی‌گرداند. |
