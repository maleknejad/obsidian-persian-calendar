...
|                                    | روز اول هفته‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |     `{{اول هفته}}`     |
|                                    | روز آخر هفته‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |     `{{آخر هفته}}`     |
|                                    |  روز اول ماه‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |      `{{اول ماه}}`     |
|                                    |  روز آخر ماه‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |      `{{آخر ماه}}`     |
|             1403-01-01             |  روز اول سال‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |      `{{اول سال}}`     |
|             1403-12-30             |  روز آخر سال‌نوشت را به شمسی یا میلادی (بر اساس تنظیمات اعمال شده) برمی‌گرداند |      `{{آخر سال}}`     |
