...
export const RELEASE_NOTES: TReleaseNote[] = [
	{
		...
		changes: [
			...
			"تغییر عبارت معنادار {{روزهای گذشته}} به {{روزهای گذشته سال}} و تغییر وابستگی آن از تاریخ جاری به تاریخ یادداشت",
			"تغییر عبارت معنادار {{روزهای باقیمانده}} به {{روزهای باقیمانده سال}} و تغییر وابستگی آن از تاریخ جاری به تاریخ یادداشت",
		],
	},
	{
		version: "4.2.2",
