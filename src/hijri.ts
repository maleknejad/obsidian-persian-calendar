export const iranianHijriAdjustments: { [key: number]: { [key: number]: number } } = {
...
export const basePersianDate = { jy: 1402, jm: 4, jd: 28 };
export const baseHijriDate = { hy: 1445, hm: 1, hd: 1 };
