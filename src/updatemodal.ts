...
export default class UpdateModal extends Modal {
    ...
    onOpen() {
        ...
        contentEl.createEl('p', { text: '- اضافه شدن {{رویداد}} برای غنی‌تر کردن نوشته‌ها بر اساس تنظیمات شما: از این به بعد می‌توانید از {{رویداد}} برای اضافه کردن رویدادها به نوشته‌های خود استفاده کنید.' });
